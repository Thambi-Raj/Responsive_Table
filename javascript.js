class Table {
    ...
    constructor(heading, data, i, color) {
        ...
        this.scroll[1].addEventListener('click', this.next_page.bind(this)); 
        this.scroll[0].addEventListener('click', this.previous_page.bind(this));
    ...
    removeTable(id){
     document.querySelectorAll('.'+id)[0].classList.remove('backdiv');//.classList.remove('backdiv');
        document.getElementById(id).classList.remove('showing');
    }
    addTable(id){
        document.querySelectorAll('.'+id)[0].classList.add('backdiv');//.classList.remove('backdiv');
